...
Pod::Spec.new do |s|
  s.name             = 'TransakSwift'
  s.version          = '0.1.0'
  s.summary          = 'A short description of TransakSwift.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Chung Tran/TransakSwift'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Chung Tran' => 'bigearsenal@gmail.com' }
  s.source           = { :git => 'https://github.com/Chung Tran/TransakSwift.git', :tag => s.version.to_s }
